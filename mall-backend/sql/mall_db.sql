...
CREATE TABLE IF NOT EXISTS register (
    ...
    address_status      register_address_enum NOT NULL DEFAULT 'NO', -- 地点使用状态
    is_active           BOOLEAN NOT NULL DEFAULT TRUE,
    created_by          BIGINT REFERENCES sys_user(id) ON DELETE SET NULL,
    created_at          TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at          TIMESTAMPTZ NOT NULL DEFAULT NOW()
...
CREATE TABLE IF NOT EXISTS "order" (
    ...
    address_id          BIGINT NOT NULL REFERENCES "address_code"(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS order_item (
    ...
    sale_mode_snap      product_sale_mode_enum NOT NULL,
...
CREATE TABLE IF NOT EXISTS payment (
    ...
    method              payment_method_enum NOT NULL,     -- 支付方式
